            ...
            <section className="booking-main-section">
                <Container>
                    ...
                    <div className="booking-header booking-header-spaced">
                        ...
                        <span>Fill in your event details and submit your booking request.</span>
                    </div>
                    ...
                    <Row className="g-4 align-items-stretch booking-layout">
                        ...
                        <Col lg={5}>
                            <Card className="booking-summary-card booking-equal-card">
                                ...
                                <p className="summary-subtitle">{selectedPackage.subtitle}</p>

                                <div className="summary-price">
                                    <span>JOD</span>
                                    <strong>{selectedPackage.price}</strong>
                                    <small>{selectedPackage.oldPrice}</small>
                                </div>

                                <p className="summary-discount">{selectedPackage.discount} OFF</p>
            ...
            {showSuccess && (
                <div className="success-overlay">
                    <div className="success-popup">
                        ...
                        <p>Your reservation has been sent to the admin team.</p>
